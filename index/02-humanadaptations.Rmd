...
This climatic variability is felt not only at a chronological level but also at a geographical level. Inland conditions (achieved by the analysis of pollen samples within the cores) seem to have been different in northern Iberia and southwestern Iberia as shown through the recovered cores in the southwestern area off Portugal: SU81-18 [@turon2003]; and to the northwestern Iberia, off Galicia: MD99-2331 and MD03-2697 [@naughton2007]. In conjunction with other climate-proxy data, such as the Greenland ice cores, charcoal studies and faunal analysis, these records have allowed for the characterization of the paleoclimatic conditions of western and southern Iberia during the Pleistocene [@cascalheiraandbicho2013; @sanchez-goni2010].

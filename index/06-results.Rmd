...
```{r general1, fig.cap="General table phase 1.", echo=FALSE}
knitr::kable(head(general_table1[1:15], 12), booktabs=TRUE,caption="Technological class by raw material for Phase 1.") %>% 
...
```{r general2, fig.cap="General table phase 2.", echo=FALSE}
knitr::kable(head(general_table2[1:15], 12), booktabs=TRUE,caption="Technological class by raw material for Phase 2.") %>% 
  column_spec(1, bold = T) %>% 
  kable_styling(latex_options = "scale_down") %>% 
  kableExtra::landscape()
```

## Assemblage - Lapa do Picareiro
...
## General table for TG (Terminal Gravettian)
...
## General table for PR (Proto-Solutrean)
...
## Plot Tables
### TG table
knitr::kable(head(general_table_TG[1:9], 9), booktabs=TRUE,caption="Technological class by raw material (Terminal Gravettian phase).") %>% 
  column_spec(1, bold = T) %>% 
  kable_styling(latex_options = "scale_down")
```
...
### PR table
knitr::kable(head(general_table_PR[1:9], 7), booktabs=TRUE,caption="Technological class by raw material (Proto-Solutrean phase).") %>% 
  column_spec(1, bold = T) %>% 
  kable_styling(latex_options = "scale_down")
```
...
```{r rmcortex, fig.cap="Cortex % by raw material, without chips and shatterfor Phase 1 and 2.", echo=FALSE}
...
RM_vb1 <- dfRM_vb1 %>% 
  ...
  scale_y_continuous(labels = scales::percent_format()) + 
  theme_minimal() + #type of theme
  labs(x = "Phase 1", y = NULL) +# change labels
  guides(fill=guide_legend(title=NULL)) + # remove legend title
  theme(axis.title.x = element_text(size = 10, vjust = -1)) + # x axis size
...
RM_vb2 <- dfRM_vb2 %>% 
  ...
  scale_y_continuous(labels = scales::percent_format()) + 
  theme_minimal() + #type of theme
  labs(x = "Phase 2", y = NULL) +# change labels
  guides(fill=guide_legend(title=NULL)) + # remove legend title
  theme(axis.title.x = element_text(size = 10, vjust = -1)) + # x axis size
  scale_fill_manual(values = c("#FF9933","#FFCC00", "#993300", 
                               "#660000", "#CC6666", "#333333")) # set colours
...
cortextabp1 <- tabmulti(dfRM3p1, "RawMaterial", c("CortexType","CortexLocation"),
...
dfRM3p2 <- dfRM_vb2 %>% 
  select(RawMaterial, Cortex, CortexType, CortexLocation)
cortextabp2 <- tabmulti(dfRM3p2, "RawMaterial", c("CortexType","CortexLocation"),
                      ymeasures = c("freq", "freq"),
                      p.include = FALSE,
                      n.headings = FALSE,
                      bold.varnames = TRUE,
...
knitr::kable(cortextabp1, booktabs=TRUE, caption = "Cortex type and localization by raw material (Phase 1).") %>% 
  column_spec(1, bold = T) %>% 
  kable_styling(latex_options = "scale_down")
...
knitr::kable(cortextabp2, booktabs=TRUE, caption = "Cortex type and localization by raw material (Phase 2).") %>% 
  column_spec(1, bold = T) %>% 
  kable_styling(latex_options = "scale_down")
...
quartzp1 %>% 
  ...
  scale_y_continuous(labels = scales::percent_format()) + 
  theme_minimal() + #type of theme
  labs(x = "Types of quartz quality (Phase 1)", y = NULL) +# change labels
  guides(fill=guide_legend(title=NULL)) + # remove legend title
  theme(axis.title.x = element_text(size = 10, vjust = -1)) + # x axis size
...
quartzp2 %>% 
  ...
  scale_y_continuous(labels = scales::percent_format()) + 
  theme_minimal() + #type of theme
  labs(x = "Types of quartz quality (Phase 2)", y = NULL) +# change labels
  guides(fill=guide_legend(title=NULL)) + # remove legend title
  theme(axis.title.x = element_text(size = 10, vjust = -1)) + # x axis size
  scale_fill_manual(values = c("#FFCC00", "#CC6666", 
                               "#660000", "#FFCC99", "#333333", "#993300", "#FF9933", "#FF6600", "#FF9999"))
...
knitr::kable(quartztab1, booktabs=TRUE, caption = "Quartz quality by class (Phase 1).") %>% 
  column_spec(1, bold = T) %>% 
...
knitr::kable(quartztab2, booktabs=TRUE, caption = "Quartz quality by class (Phase 2).") %>% 
  column_spec(1, bold = T) %>% 
  kable_styling(latex_options = c("hold_position", "scale_down"))
...
RM_TG <- dfRM_TG %>% 
  ...
  scale_y_continuous(labels = scales::percent_format()) + 
  theme_minimal() + #type of theme
  labs(x = "Raw materials (Terminal Gravettian)", y = NULL) +# change labels
  guides(fill=guide_legend(title=NULL)) + # remove legend title
  theme(axis.title.x = element_text(size = 10, vjust = -1)) + # x axis size
  scale_fill_manual(values = c("#FF9933","#FFCC00", "#993300", 
                               "#660000", "#CC6666", "#333333")) # set colours
...
cortex_TG <- dfRM_TG %>% 
  select(RawMaterial, Cortex, CortexType, CortexLocation)
cortex_tabTG <- tabmulti(cortex_TG, "RawMaterial", c("CortexType","CortexLocation"),
                      ymeasures = c("freq", "freq"),
                      p.include = FALSE,
                      n.headings = FALSE,
                      bold.varnames = TRUE,
...
knitr::kable(cortex_tabTG, booktabs=TRUE, caption = "Cortex type and localization by raw material (Terminal Gravettian).") %>% 
  column_spec(1, bold = T) %>% 
  kable_styling(latex_options = "scale_down")
```
...
quartzp2lp %>% 
  ...
  scale_y_continuous(labels = scales::percent_format()) + 
  theme_minimal() + #type of theme
  labs(x = "Types of quartz quality (Proto-Solutrean)", y = NULL) +# change labels
  guides(fill=guide_legend(title=NULL)) + # remove legend title
  theme(axis.title.x = element_text(size = 10, vjust = -1)) + # x axis size
  scale_fill_manual(values = c("#FFCC00", "#CC6666", 
                               "#660000", "#FFCC99", "#333333", "#993300", "#FF9933", "#FF6600", "#FF9999"))
...
knitr::kable(quartztab2lp, booktabs=TRUE, caption = "Quartz quality by class (Proto-Solutrean).") %>% 
  column_spec(1, bold = T) %>% 
  kable_styling(latex_options = "scale_down")
...
## RM table
RMtable <- tibble("Chert Type" = c("RM2", "RM3", "RM4", "RM5", "RM6", "RM7", "RM8"),
...
spatialRM <- datasetlp %>% 
  ...
  filter(ChertType %in% c("RM2","RM3","RM4","RM5","RM6","RM7","RM8"))
...
CP_table %>%
  ...
  mutate(Cortex = factor(Cortex, levels = c("0%", "1-30%", "31-60%", "61-99%",
                                            "100%"))) %>% # order x axis
  ggplot(aes(CorePreparProd)) +
  geom_bar(position =  "fill", aes(fill = Phase), width = 0.5) + 
  scale_y_continuous(labels = scales::percent_format()) + 
  theme_minimal() + #type of theme
...
#Elongated attribute table (all variables, by all raw materials) - Phase 2
...
```{r elongdisp1, fig.cap="Elongated product width and length dispersion by raw material (Phase 1).", echo=FALSE}
...
```{r elongdisp2,fig.cap="Elongated product width and length dispersion by raw material (Phase 2).", echo=FALSE}
...
```{r elongdisp1LP, fig.cap="Elongated product width and length dispersion by raw material (Terminal Gravettian).", echo=FALSE}
...
```{r elongdisp2LP,fig.cap="Elongated product width and length dispersion by raw material (Proto-Solutrean).", echo=FALSE}
...
knitr::kable(head(retouch_table1[1:11], 13), booktabs=TRUE, caption = "Phase 1 retouched piece typology by raw material.") %>% 
...
knitr::kable(retouch_table2, booktabs=TRUE, caption = "Phase 2 Retouched piece typology by raw material.") %>% 
  row_spec(0, bold = T, align = "c") %>% 
  kable_styling(latex_options = c("hold_position", "scale_down")) %>% 
   kableExtra::landscape()
...
knitr::kable(retouch_table1lp, booktabs=TRUE, caption = "Terminal Gravettian retouched piece typology by raw material.") %>% 
  row_spec(0, bold = T, align = "c") %>% 
  kable_styling(latex_options = c("hold_position", "scale_down"))
...
knitr::kable(retouch_table2lp, booktabs=TRUE, caption = "Phase 2 Retouched piece typology by raw material.") %>% 
  row_spec(0, bold = T, align = "c") %>% 
  kable_styling(latex_options = c("hold_position", "scale_down"))
...
VC_widthxarea_all %>% 
  ggplot(aes(x=WidthCM, y=PlatformArea, color=Group)) +
  geom_point()
```
...
VC_widthxconvexity_all %>% 
  ggplot(aes(x=WidthCM, y=PlatformConvexityCM, color=Group)) +
  geom_point()
```
...
VCplatform_all %>% 
ggplot(aes(x=PlatformWidthCM, y=PlatformThicknessCM, shape=Group, color=Group)) +
  geom_point()
```

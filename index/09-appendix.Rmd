...
knitr::kable(RMtable, booktabs=TRUE, caption = "Lapa do Picareiro. Identified chert types. Description is mostly based on colour patterns, following the Munsel manual of color chart (Munsel Color, 2010).") %>% 
...
knitr::kable(elong_tablep1, longtable= TRUE, booktabs = TRUE, caption = "Vale Boi - Lower 5 - elongated products attributes frequencies.") %>% 
  row_spec(0, bold = T, align = "c") %>% 
  kable_styling(position = "center", font_size = 9, latex_options = "repeat_header") %>% 

...
```{r spatialdistributionVB, fig.cap="Vale Boi. Spatial distribution of lithic artifacts (without chips) by raw material, on unit H.", echo=FALSE, out.width = '80%', fig.align='center'}
...
```{r chertspatial, fig.cap="Lapa do Picareiro. Spatial dispersion (Z vs Y) by chert type using total station data (contours represent a 2D Kernel density estimation).", out.width = '90%', fig.align='center', echo=FALSE, fig.pos="H"}
